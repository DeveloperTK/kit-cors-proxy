    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          <a href="https://github.com/kit-mobile/kit-cors-proxy" className={styles.card}>
            <h2>GitHub &rarr;</h2>
            <p>View this project on GitHub and find out how to use the API.</p>
          </a>

          <a href="https://github.com/kit-mobile/kit-mobile-pwa" className={styles.card}>
            <h2>KIT Mobile PWA &rarr;</h2>
            <p>See this proxy in action in the new and improved (unofficial) KIT App</p>
          </a>

          <a
            href="https://github.com/kit-mobile"
